...
- Required: `vegan`, `sampling`, `stats` [R](https://cran.r-project.org/). These are installed automatically.
- Suggested: `ggplot2` [R](https://cran.r-project.org/)
- Also `devtools`, `httr` to build `SSP` from [github](https://github.com/edlinguerra/SSP). All these must be installed by you.
...
```{r, echo = FALSE, out.width='85%', fig.align='center', fig.cap='Fig. 1. MultSE and sampling effort relationship using micromollusk simulated data'}
...
```{r, echo = FALSE, out.width='85%', fig.align='center', fig.cap='Fig. 2. MultSE and sampling effort relationship using sponge simulated data'}
